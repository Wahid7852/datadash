...
class MainApp(QWidget):
    ...
    def initUI(self):
        ...
        send_btn.clicked.connect(self.sendFile)
        receive_btn.clicked.connect(self.receiveFile)
        
        button_layout.addWidget(send_btn)
        button_layout.addSpacing(500)  # Add space between buttons
    ...
    def paintEvent(self, event):
        ...
        for i in range(3):
            ...
            painter.drawArc(center.x() - radius, center.y() - radius,
                            radius * 2, radius * 2, 0, 180 * 16)  # Changed to face upwards        
