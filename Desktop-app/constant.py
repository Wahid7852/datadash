...
current_version = "5.3"  # Set the current version of the json config file
app_version = "3.2.8"  # Set the current version of the application, note: while incrementing app_version, also increment current_version otherwise the app_version wont update for users.
